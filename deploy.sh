...
ssh prod-records sudo mkdir -p /srv/branding.citizen-science.smnh.tau.ac.il/www//brand-2023

echo ">>>>> Rsync the builded branding"

rsync -a --delete --rsync-path="sudo rsync" --info=progress2 public/ prod-records:/srv/branding.citizen-science.smnh.tau.ac.il/www//brand-2023
