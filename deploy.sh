...
ssh dev-branding sudo mkdir -p /srv/branding.cs-smnh.me/www//brand-2023

echo ">>>>> Rsync the builded branding"

rsync -a --delete --rsync-path="sudo rsync" --info=progress2 public/ dev-branding:/srv/branding.cs-smnh.me/www//brand-2023
